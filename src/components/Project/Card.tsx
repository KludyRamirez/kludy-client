...
const Technology: React.FC<{ technology: string }> = ({ technology }) => (
  <div className="project-technology cursor-pointer w-[fit-content] flex justify-center items-center py-1 px-3 gap-2 border border-slate-300 text-[14px] text-[#282828] hover:border-[#282828] hover:bg-[#282828] hover:text-white rounded-[6px] transition-all duration-300">
    <img
